...
namespace TAO.HAS.Business.Constans
{
  public static class Messages
  {
    ...
    public static string DepartmentLimitExceded;
    public static string DoctorsListed;
    ...
    internal static string HospitalAdded;
    internal static string HospitalDeleted;
